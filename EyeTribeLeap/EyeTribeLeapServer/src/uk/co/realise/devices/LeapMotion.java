...
//	                         + ", gestures " + frame.gestures().count());
	        ...
	        for(Hand hand : frame.hands()) {
	            String handType = hand.isLeft() ? "movehandleft" : "movehandright";
	            for(WebSocket ws : wss) {
					ws.send("{\"command\": \""+handType+"\"}");
					 System.out.println("Leap sent> "+handType);
				}
...
//	        }
	...
	public LeapMotion(Set<WebSocket> wss) {
